...
public partial class Movie: System.Object
{
	...
	[DllImport("libgfxunity3d")]
	protected static extern bool SF_HandleMouseEvent(long movieID, float x, float y, int icase, int buttonType);
	...
	public delegate bool SF_HandleMouseEvent(long movieID, float x, float y, int icase, int buttonType);
