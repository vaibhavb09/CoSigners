...
public partial class  Value: System.Object
{
	...
	/// <summary>
	/// Pushes num at the back of the array.
	/// </summary>
	/// <param name="val"></param>
	/// <returns>True if pushback succeeded, false otherwise (for example if the Value on which the method is called is not an array). </returns>
	public bool PushBack(Double num)
	{
		if (!IsArray())
		{
			return false;
...
#if UNITY_WP8
        return sf_pushBack(this, new Value(num, MovieId));
#else
		return SF_PushBack(this, new Value(num, MovieId));
#endif
	}
	...
	/// <summary>
	/// Pushes string at the back of the array.
	/// </summary>
	/// <param name="val"></param>
	/// <returns>True if pushback succeeded, false otherwise (for example if the Value on which the method is called is not an array). </returns>
	public bool PushBack(String str)
	{
		if (!IsArray())
		{
			return false;
...
#if UNITY_WP8
        return sf_pushBack(this, new Value(str, MovieId));
#else
		return SF_PushBack(this, new Value(str, MovieId));
#endif
	}
