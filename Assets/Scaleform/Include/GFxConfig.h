...
#if defined(SF_OS_ANDROID) || defined(SF_OS_IPHONE) || defined(SF_OS_3DS) || (defined(SF_OS_WINMETRO) && !defined(_DURANGO))
#define GFX_MULTITOUCH_SUPPORT_ENABLE
#endif
...
// Enable/disable addons for MSVC builds
    ...
    #define GFX_USE_VIDEO
#elif defined(SF_OS_ORBIS) && defined(GFX_USE_VIDEO_ORBIS)
    #define GFX_USE_VIDEO
...
// Define this macro to enable video support (including core and ActionScript)
    ...
    defined(SF_OS_WIIU)    || defined(SF_OS_ORBIS))
...
// HIO allowed only for debugging by Nintendo
...
//Turn off BitmapData for Unity3D Integration
#ifdef SF_BUILD_UNITY
#undef  GFX_AS2_ENABLE_BITMAPDATA
#endif //SF_BUILD_UNITY
...
#if ( defined(SF_OS_PSVITA) || defined(SF_OS_PS3) || defined(SF_OS_XBOX360) || defined(SF_OS_3DS) || defined(SF_OS_WIIU) || defined(SF_OS_WIN32) )
